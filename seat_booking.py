...
Label(root,text = "From").grid(row=3 , column = 4)
Text(root, width = 20 , height = 1).grid(row = 3 , column =5)
Label(root,text = "Journey Date").grid(row=3 , column = 6)
Text(root, width = 20 , height = 1).grid(row = 3 , column =7)
Button(root, text= 'Show Buses',fg ='black' ,bg= 'light green',command='detail').grid(row= 3 ,column = 8)
img1 =PhotoImage(file="home.png")
Button(root,fg ='black' ,bg= 'light green',image = img1,command=home).grid(row= 3 ,column = 10, padx = 10)
root.mainloop()
